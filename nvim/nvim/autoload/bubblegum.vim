...
let s:gui_star_field_red="#c92337"
let s:gui_star_field_orange="#e16237"
let s:gui_star_field_yellow="#d8a554"
let s:gui_star_field_dark_blue="#233052"
let s:gui_star_field_mid_blue="#2f4b7a"
let s:gui_star_field_light_blue="#4a668e"
let s:cterm_star_field_red=229
let s:cterm_star_field_orange=208
let s:cterm_star_field_yellow=229
let s:cterm_star_field_dark_blue=27
let s:cterm_star_field_mid_blue=75
let s:cterm_star_field_light_blue=159
...
"选中的窗口
let s:N1 = [s:gui_dark_gray, s:gui_green, s:cterm_dark_gray, s:cterm_star_field_light_blue]
"let s:N2 = [s:gui_light_gray, s:gui_med_gray_lo, s:cterm_light_gray, s:cterm_med_gray_lo]
"git 编码格式
let s:N2 = [s:gui_light_gray, s:gui_med_gray_lo, s:cterm_dark_gray, s:cterm_white]
"let s:N3 = [s:gui_green, s:gui_med_gray_hi, s:cterm_green, s:cterm_med_gray_hi]
"其他窗口
let s:N3 = [s:gui_green, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_lo]
...
let g:airline#themes#bubblegum#palette.normal_modified = {
      \ 'airline_c': [s:gui_orange, s:gui_med_gray_hi, s:cterm_star_field_mid_blue, s:cterm_med_gray_lo, ''], 
      \ }
...
let s:V1 = [s:gui_dark_gray, s:gui_pink, s:cterm_dark_gray, s:cterm_star_field_yellow]
" let s:V3 = [s:gui_pink, s:gui_med_gray_hi, s:cterm_pink, s:cterm_med_gray_hi]
let s:V3 = [s:gui_pink, s:gui_med_gray_hi, s:cterm_star_field_yellow, s:cterm_med_gray_hi]
